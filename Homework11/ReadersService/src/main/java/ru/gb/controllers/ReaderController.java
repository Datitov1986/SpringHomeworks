...
import ru.gb.services.ReaderIssuesService;
...
public class ReaderController {
    ...
    private final ReaderIssuesService readerIssuanceService;
    ...
    public ResponseEntity<List<IssuanceDTO>> getIssuanceByIdReader(@PathVariable long id) {
