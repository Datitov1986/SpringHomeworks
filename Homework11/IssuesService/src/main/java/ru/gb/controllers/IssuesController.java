...
import ru.gb.services.IssuesService;
...
public class IssuesController {
    private final IssuesService issuanceService;
    ...
    @GetMapping
    public ResponseEntity<List<IssuanceDTO>> issuanceList() {
        final List<IssuanceDTO> issuanceList;
        try {
    ...
    @PostMapping
    public ResponseEntity<Issuance> issuanceBook(@RequestBody IssuesRequest issuanceRequest) {
        Issuance issuance;
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<IssuanceDTO> returnBookByReader(@PathVariable long id) {
        IssuanceDTO issuanceTransform;
        try {
            issuanceTransform = issuanceService.getIssuanceById(id);
    ...
    public ResponseEntity<List<IssuanceDTO>> returnIssuanceByIdReader(@PathVariable long id) {
        List<IssuanceDTO> issuanceList;
        try {
